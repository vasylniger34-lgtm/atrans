...
const FAQ_ITEMS = [
  ...
  {
    question: "Як працює купівля авто під ключ з європейських аукціонів (Auto1, Copart, BCA, CarTV, Ayvens, Autobid)?",
    answer: "Ви економите від 15% від ринкової вартості авто в Україні. Ми надаємо повний супровід: підбір, участь у торгах на майданчиках Auto1, Copart, BCA, CarTV, Ayvens, Autobid, перевірка історії, викуп, доставка автовозом в Україну та допомога з розмитненням."
  },
  {
