      ...
      <div className="contacts-grid">
        ...
        <div className="social-links glass">
          ...
          <div className="social-grid">
            <a href="https://www.instagram.com/a_trans__" target="_blank" rel="noreferrer" className="social-btn instagram">
            ...
            <a href="https://www.tiktok.com/@atrans4" target="_blank" rel="noreferrer" className="social-btn tiktok">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
            ...
            <a href="https://t.me/+380634872745" target="_blank" rel="noreferrer" className="social-btn telegram">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
            ...
            <a href="viber://chat?number=%2B380634872745" target="_blank" rel="noreferrer" className="social-btn viber">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
            ...
            <a href="https://wa.me/380634872745" target="_blank" rel="noreferrer" className="social-btn whatsapp">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
